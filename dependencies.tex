...
\begin{compactitem}
\item CHOST build dependencies (\t{DEPEND}), typically headers and libraries. These
...
\item \featurelabel{bdepend} CBUILD build dependencies (\t{BDEPEND}), typically
    executable build tools. These must be installed and usable before any of the ebuild
